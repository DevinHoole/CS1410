...
//this doubles the capacity of our dynamic memory array by creating a new pointer allocaitng to _capacity*char32_
//copy over old myArray, delete old newArray, set
